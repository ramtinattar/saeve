    ...
    _createClass(Popover, [{
      ...
      value: function _position() {
        ...
        fastdom.measure(function () {
          ...
          if (position === 'top') {
            topPosition = activatorBoundingRect.top - _this4.element.clientHeight - threshold + 50;
      ...
      value: function _initFeed() {
        ...
        if (!this.instafeed.hasAttribute('data-access-token')) {
          ...
          var instafeed = new Instafeed({
            ...
            template: '<a href="{{link}}" target="_blank" rel="noopener" class="Carousel__Cell Instafeed__Cell">' + '<div rel="noopener" class="Instafeed__Image Image--lazyLoad Image--zoomOut" data-expand="10" data-bg="{{image}}" aria-label="Open on Instagram"></div>' + '<div class="Instafeed__Overlay">' + '<span class="Instafeed__LikeCount">' + '<svg class="Icon Icon--heart" viewBox="0 0 17 15" role="presentation">' + '<path d="M15.0349331 1.40485867C14.1287273.49933787 12.9252477 0 11.6443673 0S9.16000731.49933787 8.25448651 1.40417371c-.01164437.01164436-.02328874.02328873-.03493311.03561806-.01164436-.01232933-.02260377-.02328873-.03424813-.0349331C7.2790995.49933787 6.07561989 0 4.79473949 0 3.51385908 0 2.31037947.49933787 1.40417371 1.40485867.49796794 2.31037947 0 3.51385908 0 4.79473949 0 6.07561989.4986529 7.2790995 1.40417371 8.1846203L8.2195534 15l6.8153797-6.8153797c.9055208-.9055208 1.4041737-2.10900041 1.4041737-3.38988081 0-1.28019545-.4986529-2.48436002-1.4041737-3.38988082z"></path>' + '</svg>' + '{{likes}} likes' + '</span>' + '<p class="Instafeed__Caption">{{caption}}</p>' + '<time class="Instafeed__Date Heading u-h6">{{model.date}}</time>' + '</div>' + '</a>',
...
// increase the number of pannier in collection onclick

$('#shopify-section-collection-template').find('.ProductForm__AddToCart').click(function() {
  setTimeout(function(){
    $('.Header__CartCount').html(function(i, val) { return val*1+1 });
  }, 1000);
});
